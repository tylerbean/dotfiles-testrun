...
echo -e "\n### Getting mirrors"
reflector --save /etc/pacman.d/mirrorlist --country "United States" -p https --sort rate -l 15 --threads 15 > /dev/null
pacman -Syy > /dev/null
...
pacman -Sy --noconfirm --needed git dialog wget terminus-font
